...
if ($_SERVER ['REQUEST_METHOD'] == 'POST') {
	...
	if ($ctrl_envioMail) {
		...
		if ($resultado_u === false) {
			...
			if ($registro_u ['' . '_usuorigen'] != "" && $registro_u ['mail_usuorigen'] != NULL && $registro_u ['mail_usuorigen'] != "NULL") {
		...
		if ($mailUsu != "" && $mailUsu != NULL && $mailUsu != "NULL") {
			$destinatarios_mail = $mailST . ", " . $mailUsu . ", " . $mailAnaM . ", " . $mail_responsable . ", " . $mail_usuorigen . ", " . $mailResponsableUsuOrigen;
		} else {
			$destinatarios_mail = $mailST . ", " . $mailAnaM . ", " . $mail_responsable . ", " . $mail_usuorigen;
		}
