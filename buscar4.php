	...
	if($_SERVER['REQUEST_METHOD']=='POST') {
		...
		//if ($_POST['buscar']) {
			if (isset($id) && $id != "") {
				...
				$tsql = "SELECT TOP 1000 * FROM INV_VIEW_DATOS_TODO WHERE REF_TBTAREA LIKE '%".$id."%' 
			...
			<FORM id="busqueda" autocomplete="off" METHOD="POST" NAME="opciones"  class="form-horizontal">
				...
				<div class="row-fluid">  		
					...
					<?php } ?>
                                            ...
                                            <td>
                                                <button type="submit" class="btn btn-primary" name="buscar" id = "buscar" onclick = "this.form.action = 'buscar4.php'"><i class="halflings-icon white search"></i> Buscar</button>                                            
