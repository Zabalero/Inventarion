<?php
    ...
    if ($id == 0) {
	 	$tsql = "SELECT TOP 1 *
				...
				WHERE INV_TBTAREAS.id_actuacion='".$idActuacion."' ";
	} else {
	 	$tsql = "SELECT *
				FROM INV_TBTAREAS
				LEFT JOIN INV_VIEW_DATOS_TODO ON INV_VIEW_DATOS_TODO.ID_TAREA = INV_TBTAREAS.ID
	...
	$tsql = "SELECT *
			FROM INV_TBTAREAS
			LEFT JOIN INV_VIEW_DATOS_TODO ON INV_VIEW_DATOS_TODO.ID_TAREA = INV_TBTAREAS.ID
			WHERE INV_TBTAREAS.id_actuacion='".$idActuacion."' AND INV_TBTAREAS.ID <> '$id' 
...
<body>
<form method="post" action="consultarTareasActuacion.php" role="form">
		...
		<div class="row-fluid orange">
			...
			<div class="control-group form-group span2">
				<div class="controls" style="padding-left:5px;">
					<strong>REGION: </strong><br/><input readonly="true" type="text" class="form-control input uneditable-input" name="REGION" value="<?php echo $registro['REGION'];?>">
				</div>
			</div>				
			<div class="control-group form-group span2">
				<div class="controls">
					<strong>PROVINCIA: </strong><br/><input readonly="true" type="text" class="form-control input uneditable-input" name="PROVINCIA" value="<?php echo $registro['PROVINCIA'];?>">
				</div>
			</div>	
			<div class="control-group form-group span2">
				<div class="controls">
					<strong>CABECERA: </strong><br/><input readonly="true" type="text" class="form-control input uneditable-input" name="CABECERA" value="<?php echo $registro['CABECERA'];?>">
				</div>
			</div>
			<div class="control-group form-group span2">
				<div class="controls">
					<strong>ARBOL: </strong><br/><input readonly="true" type="text" class="form-control input uneditable-input" name="ARBOL" value="<?php echo $registro['ARBOL'];?>">
				</div>
			</div>	
			<div class="control-group form-group span2">
				<div class="controls">
					<strong>ID_ACTUACION: </strong><br/><input readonly="true" type="text" class="form-control input uneditable-input" name="ID_ACTUACION" value="<?php echo $registro['ID_ACTUACION'];?>">
				</div>
			</div>
			<div class="control-group form-group span2">
				<div class="controls">
					<strong>EEMM: </strong><br/><input readonly="true" type="text" class="form-control input uneditable-input" name="REGION" value="<?php echo $registro['EEMM'];?>">
				</div>
			</div>						
		</div>
		...
		<div style="padding-left:5px;">
			<div class="row-fluid">
				...
				<div class="span2" ontablet="span4" ondesktop="span2">
					...
					<div class="control-group form-group">
						<div class="controls">
							<strong>ID_MAPEO: </strong><br/><input readonly="true" type="text" class="form-control input uneditable-input" name="ID_MAPEO" value="<?php echo $registro['ID_MAPEO'];?>">
						</div>
					</div>	
				</div>
						...
						<table class="table table-striped table-bordered bootstrap-datatable datatable">
						  ...
						  <tbody>
	                         ...
	                         <?php while ($lineaAsoc = sqlsrv_fetch_array($resultado)){ ?>
									...
									<td class="center">
										<INPUT TYPE="submit" class="btn btn-success btn-mini" value="Consultar" onclick = "this.form.action = 'consultarTareasActuacion.php?dato=&idIncidencia=<?php echo $lineaAsoc['ID_TAREA']; ?>'">
