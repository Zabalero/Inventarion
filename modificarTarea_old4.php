			...
			$selected_CTOGESC = $_POST['CTOgesc'];
                ...
                if ($ctrl_envioMail){
                   ...
                   // $tecnico = $_REQUEST['tecnico'];
                    ...
                    $sql_u="select *, (select mail from INV_tbUSUARIOS where id_usu=tbu.idResponsable) as mail_responsable,"
                    ...
                    switch ($selected_cambioEst) {
                            ...
                            $cuerpo=$cuerpo.'<p><strong>COMENTARIOS:</strong> '.$comentarios.'</p>		
                                            <p>Un saludo</p>
