			...
			<FORM id="busqueda" autocomplete="off" METHOD="POST" NAME="opciones"  class="form-horizontal">
							...
							<div class="controls">
								<?php
									...
									if (isset($restriccion) && $restriccion != "Todas") {			 
										$region = $restriccion;	
										if (isset($region) && $region != "") {
											$tsql="select Descripcion as REGION from inv_regiones WHERE Descripcion = '$region' order by Descripcion";
										} else {
				...
				<div class="row-fluid">
					<div class="span2">
						<div class="control-group">
							<div class="controls">
								<INPUT TYPE="submit" class="btn btn-primary" NAME="buscar" id = "buscar" VALUE="Buscar" onclick = "this.form.action = 'buscar.php'">  
					...
					<div class="span2">
						<div class="control-group">
							<div class="controls">
								...
								<a href="scripts/excelExport.php?origen=DESCARGA_TAREAS" title="Exportar TAREAS" class="btn btn-success btn-mini">		
