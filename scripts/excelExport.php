...
if ($solicitud === 'Saturadas') {
	...
	$tsql = "SELECT D.NUMERO as NUMERO,CTO_NUEVA,REF,
		inv_tbTareas.id AS ID_TAREA,
                ...
                WHERE ((Actividad='General' AND SUBACTIVIDAD='Seguimiento Ampliaciones CTOS Saturadas') or ( SUBACTIVIDAD='Rediseño de RED') or (SUBACTIVIDAD='Ampl. de red-CTOS saturadas') or (SUBACTIVIDAD='Diseño – CTO saturada') or (Actividad='General' AND SUBACTIVIDAD='Activación Puertos') or  (Actividad='Incidencia - Cliente' AND SUBACTIVIDAD='ACTIVACION DE PUERTOS')) and ( (inv_tbtareas.FECHA_RESOL> = '2019-01-01') or (inv_tbtareas.FECHA_RESOL is null)) ;";
                $stmt = sqlsrv_query( $conn, $tsql );
