...
function confirmarSubir() {
    if(confirm("Si ya existe un archivo subido anteriormente para esta tarea, será sustituido. ¿Desea continuar?"))
    {
        return true;
    }
    return false;
...
$(".btn-success.actividades").click(function(){
...
$(".btn-info.actividades").click(function(){
      var button = $(this); // Button that triggered the modal
      var idSelect = button.data('id'); // Extract info from data-* attributes
      var modal = button.data('target');
      var dataString = 'id=' + idSelect;
...
$(".btn-danger.actividades").click(function(){
      var button = $(this); // Button that triggered the modal
      var idSelect = button.data('id'); // Extract info from data-* attributes
      var modal = button.data('target');
