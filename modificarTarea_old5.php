                ...
                if ($ctrl_envioMail){
                   ...
                   // $tecnico = $_REQUEST['tecnico'];
                    ...
                    if( $resultado_u === false ) {
                        ...
                        $des_grupo_u=$registro_u['des_grupo'];
                        if ($registro_u[''
                    ...
                    if (isset($selected_cambioEst) && $selected_cambioEst!="") {
                         ...
                         switch ($selected_cambioEst) {
                            ...
                            //echo ($selected_cambioEst."-".$cuerpo);exit();
                             $cuerpo=$cuerpo.'
                                            <p><span style="font-style: italic">Estado: </span>'.$estado.'<span style="font-weight: bold"></span></br>								
                            ';	
                    ...
                    if (isset($comentarios2) && $comentarios2!="") {
                            ...
                            $listaComentarios = split ('-',$comentarios);
                            
                            $cuerpo=$cuerpo.'<p><strong>COMENTARIOS:</strong></p>';
                            
                            foreach ($listaComentarios as $comentario){
                                $cuerpo=$cuerpo.'<p>-'.$comentario.'</p></br>';
                            }
			...
			<form method="post" action="modificarTarea.php" role="form" enctype="multipart/form-data">
				...
				<div class="row-fluid">
					...
					<div class="span4">
						...
						<div class="control-group form-group">
							<div class="controls">
								<strong>ESCALADO: </strong><br><input type="text" class="form-control input" name="TICKET_ESCALADO" value="<?php echo $ticket_escalado;?>">
							</div>
						</div>	
                                                <div class="control-group form-group">
							<div class="controls">
