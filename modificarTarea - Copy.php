			...
			$selected_CTOGESC = $_POST['CTOgesc'];
                ...
                if ($ctrl_envioMail){
                   ...
                   // $tecnico = $_REQUEST['tecnico'];
                    ...
                    $sql_u="select *, (select mail from INV_tbUSUARIOS where id_usu=tbu.idResponsable) as mail_responsable, INV_tbGrupos.grupo as des_grupo,"
                            . "(select mail from INV_tbUSUARIOS where id_usu=".$id_usuorigen.") as mail_usuorigen from INV_tbUSUARIOS as tbu, INV_tbGrupos where usuario='".$_SESSION['usuario']."' and tbu.idGrupo=INV_tbGrupos.id_grupo";
                    //echo $sql_u;exit();
                    ...
                    if( $resultado_u === false ) {
                        ...
                        if ($registro_u[''
                            . '_usuorigen']!="" && $registro_u['mail_usuorigen']!=NULL && $registro_u['mail_usuorigen']!="NULL"){
                    ...
                    if (isset($comentarios2) && $comentarios2!="") {
                            ...
                            */
                            ...
                            if ($mailUsu!="" && $mailUsu!=NULL && $mailUsu!="NULL"){
                                $destinatarios_mail=$mailST.", ".$mailUsu.", ".$mailAnaM.", ".$mail_responsable.", ".$mail_usuorigen;
                            } else {
					...
					<div class="control-group form-group span2">
						<div class="controls">
							<strong>ACT. JAZZTEL: <br /></strong>
								<input type="text" class="form-control input"  name="actJazz" value="<?php echo $act_jazztel;?>"/>
                                                          ...
                                                          <div class="control-group form-group">
                                                                            <div class="controls">
                                                                                    ...
                                                                                    <select name="TICKET_ESCALADO">
                                                                                      <option value=""></option>
                                                                                      <option value="GAMMA" <?php if ($ticket_escalado=== "GAMMA"){?> selected <?php } ?>>GAMMA</option>
                                                                                      <option value="Reg_Cataluña" <?php if ($ticket_escalado=== "Reg_Cataluña"){?> selected <?php } ?>>Reg_Cataluña</option>
                                                                                      <option value="Reg_Centro" <?php if ($ticket_escalado=== "Reg_Centro"){?> selected <?php } ?> >Reg_Centro</option>
                                                                                      <option value="Reg_Levante" <?php if ($ticket_escalado=== "Reg_Levante"){?> selected <?php } ?>>Reg_Levante</option>
                                                                                      <option value="Reg_Noroeste" <?php if ($ticket_escalado=== "Reg_Noroeste"){?> selected <?php } ?>>Reg_Noroeste</option>
                                                                                      <option value="IBM" <?php if ($ticket_escalado=== "IBM"){?> selected <?php } ?>>IBM</option>
                                                                                      <option value="Ingenieria" <?php if ($ticket_escalado=== "Ingenieria"){?> selected <?php } ?>>Ingenieria</option>
                                                                                      <option value="Reg_Oriental" <?php if ($ticket_escalado=== "Reg_Oriental"){?> selected <?php } ?>>Reg_Oriental</option>
                                                                                      <option value="Reg_Occidental" <?php if ($ticket_escalado=== "Reg_Occidental"){?> selected <?php } ?>>Reg_Occidental</option>
                                                                                      <option value="ACCENTURE" <?php if ($ticket_escalado=== "ACCENTURE"){?> selected <?php } ?>>ACCENTURE</option>
                                                                                      <option value="EEMM" <?php if ($ticket_escalado=== "EEMM"){?> selected <?php } ?>>EEMM</option>
                                                                                      <option value="SSTT" <?php if ($ticket_escalado=== "SSTT"){?> selected <?php } ?>>SSTT</option>
                                                                                      <option value="Telefonica" <?php if ($ticket_escalado=== "Telefonica"){?> selected <?php } ?>>Telefonica</option>
                                                                                    </select>
                                                                            </div>
                                                                    </div>	
                                                                    <div class="control-group form-group">
                                                                            <div class="controls">
                                                                                    <strong>SUC: </strong><br><input type="text" class="form-control input" name="SUC" value="<?php echo $suc;?>">
                                                                            </div>
                                                                    </div>	
